...
( sleep 1; (command -v open >/dev/null && open "http://127.0.0.1:8096/") || \
  (command -v xdg-open >/dev/null && xdg-open "http://127.0.0.1:8096/") ) >/dev/null 2>&1 &
exec $PY engine.py --serve 8096
