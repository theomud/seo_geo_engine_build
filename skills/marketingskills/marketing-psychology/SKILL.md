...
description: "When the user wants to apply psychological principles, mental models, or behavioral science to marketing. Also use when the user mentions 'psychology,' 'mental models,' 'cognitive bias,' 'persuasion,' 'behavioral science,' 'why people buy,' 'decision-making,' 'consumer behavior,' 'anchoring,' 'social proof,' 'scarcity,' 'loss aversion,' 'framing,' or 'nudge.' Use this whenever someone wants to understand or leverage how people think and make decisions in a marketing context. Triggers: 'what bias applies here', 'why won't people convert', 'how do I make this more persuasive'. For applying psychology to a specific page or funnel, defer to cro; for the words on the page, defer to copywriting."
metadata:
  version: 2.0.0
---
...
**Freedom Dial: HIGH (judgment work).** There is no single correct mental model for a given situation — the skill of value is diagnosis and matching. This file gives you a catalogue of models plus the principles for choosing among them; reason from them, do not run them as a fixed checklist. Two exceptions are mechanical and have one right answer: the **Rule of 100** discount-framing rule and **charm vs. rounded pricing** — apply those exactly as written.

## North Star objective

Pick the *fewest, most-fitting* models for the user's actual situation and translate each into a concrete, ethical marketing move they can ship. Diagnose before prescribing; never dump the whole catalogue. Ethics is a hard guardrail — only deploy scarcity, defaults, anchors, and commitment tactics when they reflect something genuinely true.
...
- **Model-dumping.** Listing ten biases for one problem. Diagnose first, then name the two or three that actually fit.
- **Fake scarcity / dark patterns.** "Only 2 left!" when stock is unlimited, opt-out traps the user can't see, countdown timers that reset. These violate the ethics guardrail and, for a confiscation-fearful ICP like Maya, destroy the exact trust the page needs.
- **Jargon as the deliverable.** Telling the user "use the endowment effect" without the concrete move ("offer a no-charge pre-move consultation so they mentally own the relocation plan").
- **Wrong skill.** Rewriting page copy or restructuring a funnel here — that is copywriting and cro. This skill diagnoses *which* lever; the sibling builds it.
- **Ignoring the buyer's starting belief.** Applying a model that fights what the customer already believes instead of aligning with it (Confirmation Bias).

## Real examples

**Input:** "Our PawRoute quote page gets visits but almost no one books the consultation."
**Diagnosis (high-freedom reasoning):** Maya's dominant emotion is fear of confiscation, not price sensitivity. The blocker is regret aversion and status-quo bias, not motivation.
**Output (concrete moves):**
- *Regret Aversion* — add a guarantee that removes the catastrophic downside: "If your dog can't fly on the booked date, we re-book at no charge." Names the exact fear, then dissolves it.
- *Activation Energy* — replace "Book a consultation" with a pre-filled 2-field "Check my dog's route" micro-step, so the first action is trivially easy.
- *Authority Bias* — surface the IATA/MOCCAE compliance credential next to the CTA, because for this buyer credentials beat persuasion.

**Input:** "Should our Dubai-to-UK package end in 9 or be a round number?"
**Output (low-freedom rule):** Premium relocation buyers read round prices as quality (Rounded-Price Effect) — use AED 12,000, not AED 11,999. For a budget add-on under AED 100 (e.g. a crate), charm pricing applies: AED 95, not AED 100.

## Self-check validation

- [ ] Did I diagnose the situation before naming any model?
- [ ] Did I pick the *fewest* fitting models (roughly 2-3), not the whole catalogue?
- [ ] Is every model translated into a concrete, shippable marketing move?
- [ ] Does every tactic reflect something genuinely true (ethics guardrail)?
- [ ] Did I defer page/funnel building to cro and copy wording to copywriting?
- [ ] One term per concept: "customer" for the buyer throughout (not user/prospect/lead)?

## Known gaps

- **No measurement.** This skill names plausible levers; it does not run or analyse the A/B test that proves a model works on *this* audience. Pair with an experimentation workflow before claiming lift.
- **Western-bias catalogue.** The effects here come from predominantly Western behavioural-science literature; effect sizes and even direction can differ for the UAE/expat audiences this repo serves. Treat each as a hypothesis, not a law.
- **Pricing overlap.** Pricing Psychology lives both here and in cro; there is no standalone `pricing` skill. If the request is purely pricing-page mechanics, cro is the better home — flagged so the two don't drift.

---

## Related Skills

- **cro**: Apply psychology to a specific page or funnel; also the home for pricing-page mechanics.
- **copywriting**: Write the actual on-page words using these principles.
- **customer-research**: Establish what the customer believes *before* you choose a model.
- **content-strategy**: Sequence touchpoints (Rule of 7, mere exposure) across a campaign.
